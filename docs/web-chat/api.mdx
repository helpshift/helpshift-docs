...
The Logout API is introduced along with the [new Identity system](/web-chat/users/#managing-users-with-the-identity-system).
You can refer to the linked section for details.
...
Refer to [identity token format](/web-chat/users/#identity-token-format) for the schema of the identity
token.
...
to work with the [new Identity system](/web-chat/users/#managing-users-with-the-identity-system).
You can refer to the linked section for details.
