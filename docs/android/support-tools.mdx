...
<a id="embeddable-fragments-handle-backstack"></a>
### Handling onBackPressed with Helpshift's Embeddable Fragments
...
<a id="embeddable-fragments-handle-language"></a>
### Handling language change with Helpshift's embeddable fragments
...
<a id="embeddable-fragments-hardware-acceleration"></a>
### Enabling hardware acceleration in Manifest
