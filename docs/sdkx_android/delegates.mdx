...
- Event data: 
  ...
  - `Helpshift.DATA_ACTION_TYPE `
  - `Helpshift.DATA_ACTION_TYPE_CALL `
  - `Helpshift.DATA_ACTION_TYPE_LINK `
...
| Helpshift.DATA_ACTION_TYPE  | actionData | String |
| Helpshift.DATA_ACTION_TYPE_CALL  | call | String |
| Helpshift.DATA_ACTION_TYPE_LINK  | link | String |
          ...
          case HelpshiftEvent.AGENT_MESSAGE_RECEIVED:
            ...
            if (Utils.isEmpty(attachments)) {
              ...
              for (int i = 0; i < attachments.size(); i++) {
                ...
                Log.d(TAG, "attachment " + (i + 1) + " url " + url + " contentType " + contentType + " fileName " + fileName + " size " + size);
              }
            }
        }
  }});
