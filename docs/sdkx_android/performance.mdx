...
The Helpshift SDK X will add `294 Kb` to your application's release APK.
This analysis was done with Android Gradle Plugin `v8.1.0` and Gradle `v8.1`.
The `294 Kb` size includes total impact with all the resources and code.

<a id="methods-count"></a>
### Method count

The Helpshift SDK X will add 2209 methods to your dex:
