...
This API is meant to be used along with the new [User Identity system](/sdkx_android/identity-users). Use this API to update global data associated with the logged in user.
...
This API is meant to be used along with the new [User Identity system](/sdkx_android/identity-users). Use this API to update app specific data associated with the logged in user.
...
Attributes update APIs sync their data with Helpshift servers in batches. There is a chance of attribute updates 
