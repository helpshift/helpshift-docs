...
Customers who are on/moving to SDK X, need to ensure they are supporting installing their apps/games only on API Level 24 and above [Android OS 7 and above]. After 10.3 is released, they can start supporting API Level 21 and above.
