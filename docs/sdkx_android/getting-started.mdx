...
* SDK X is functional only above API Level 21 i.e Android OS 5 Lollipop and above. [Update (August 2023): SDK X 10.2.x is functional only above API Level 24 i.e Android OS 7 Nougat and above]
