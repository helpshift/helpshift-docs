...
If you are on SDK X, or migrating to SDK X, you need to ensure that you are supporting the installation of your app only on API Level 24 and above (Android OS 7 and above). After SDK X v10.3.0 is released, you can start supporting API Level 21 and above.
