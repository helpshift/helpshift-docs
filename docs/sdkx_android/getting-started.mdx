...
<a id="minimum-supported-android-version"></a>
## Requirements
...
<Admonition type="info" title="Note">
  ...
  - SDK doesn't support downgrading and SDK behavior may be un-predictable if downgraded.
...
Refer [User Hub documentation](/sdkx_android/identity-user-hub/#user-hub-implementation-flow-diagram) for SDK integration details.
