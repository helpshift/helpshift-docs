...
- Debug build for debug logs in SDK is not required any more
- Fixed an edge case bug where message count was incorrect when login and unread message count was invoked in quick succession.
