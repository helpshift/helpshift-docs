...
- Deprecated old [Outbound Support](/sdkx_android/outbound-support/) with introduction of **Proactive Engagement**.
- Added new API to pause in-app notifications. This will pause/unpause in-app notifications for Proactive Engagement notifications. Please refer [shouldPauseInAppNotification](/sdkx_android/proactive-engagement/#pausing-inapp-notifications) here for details.
