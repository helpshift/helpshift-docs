...
From 10.3.0, `Helpshift.login()` API will return a boolean indicating wheather login was successful or not. This change is in existing API to introduce mandatory validations for login parameters and hence this might affect code compilation.
