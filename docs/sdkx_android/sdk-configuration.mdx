...
The `filter` option will be should be added as an object against key “filter” in the map `config` that is taken by showFAQs, showFAQSection and showSingleFAQ APIs.
