...
This approach is the standard approach, where the game developers will have control over the <br/>widget's life cycle using the set of [Helpshift API's](/pc-widget-unity/available-apis/) that are provided.
