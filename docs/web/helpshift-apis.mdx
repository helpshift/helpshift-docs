...
The API will return a status code of 201 for successful response, 400 for invalid requests.
...
<table>
  ...
  <tr>
    <td>uid</td>
    <td rowspan="3">At least one of these fields is required to identify an end user.</td>
    <td>User ID</td>
  </tr>
  <tr>
    <td>email</td>
