...
description: "The Helpshift SDK v2.4.0 is a major update and we have deprecated some APIs. If you have questions or feedback, please Contact Us"
---
...
The Helpshift SDK v2.4.0 is a major update and we have deprecated some APIs. If you have questions or feedback, please <a href="https://support.helpshift.com/kb/contact/" target="_blank">Contact Us</a>
...
For more information, see [Check Active Conversation](/xamarin/tracking-ios#check-if-conversation-active)
...
For more information, see [Notifications Count](/xamarin/notifications-ios#showing-notification-count)
