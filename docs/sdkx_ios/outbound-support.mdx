...
Implement public interface `HelpshiftProactiveAPIConfigCollectorDelegate` in your AppDelegate class and call `setProactiveAPIConfigCollectorDelegate:self` method to initialise the config collector delegate after call of install Helpshift SDK
