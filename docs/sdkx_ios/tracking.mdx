...
This API is meant to be used along with the new [User Identity system](/sdkx_ios/identity-users). Use this API to update global data associated with the logged in user.
...
This API is meant to be used along with the new [User Identity system](/sdkx_ios/identity-users). Use this API to update app specific data associated with the logged in user.
