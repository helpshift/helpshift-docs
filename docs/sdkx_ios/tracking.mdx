...
This API is meant to be used along with the new [User Identity system](/sdkx_ios/identity-users). Use this API to update global attributes associated with the logged in user.
...
This API is meant to be used along with the new [User Identity system](/sdkx_ios/identity-users). Use this API to update app specific attributes associated with the logged in user.
