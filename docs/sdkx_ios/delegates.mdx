...
This event is triggered when the user receives any message from an agent in a conversation. It might be a text message or an attachment. This delegate is not triggered for bot messages or messages sent via automations.
