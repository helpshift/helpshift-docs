...
- Select the desired action from available options, fill up the notification content and add context as per your needs. Intents/CIFs/tags/initial message etc configured here will be used when the end user starts a conversation by clicking on the notification.
