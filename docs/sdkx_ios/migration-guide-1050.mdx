...
Replace usage of deprecated API in `userNotificationCenter:willPresent:withCompletionHandler:` with [`handleForegroundNotification:withCompletionHandler:`](/sdkx_ios/notifications/#push-delegates-foreground) -
...
Replace usage of deprecated API in `userNotificationCenter:didReceive:withCompletionHandler:` with [`handleBackgroundNotificationClick:withCompletionHandler:`](/sdkx_ios/notifications/#push-delegates-background) -
...
|------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| `clearAnonymousUserOnLogin`                                            | [`clearAnonymousUserOnLogin:`](/sdkx_ios/users/#anonymous-users)  - Pass boolean true to clear/false to not clear                           |
| `showConversationWith:config:`                                         | [`showConversationWithConfig:`](/sdkx_ios/support-tools/#conversation-view)  - No need to pass in view controller                                     |
| `showFAQsWith:config:`                                                 | [`showFAQsWithConfig:`](/sdkx_ios/support-tools/#faqs-view)  - No need to pass in view controller                                             |
| `showFAQSection:with:config:`                                          | [`showFAQSection:withConfig:`](/sdkx_ios/support-tools/#faq-section-view)  - No need to pass in view controller                                      |
| `showSingleFAQ:with:config:`                                           | [`showSingleFAQ:withConfig:`](/sdkx_ios/support-tools/#faq-view)  - No need to pass in view controller                                       |
| `handleNotificationWithUserInfoDictionary:isAppLaunch:withController:` | [`handleForegroundNotification:withCompletionHandler:`](/sdkx_ios/notifications/#push-delegates-foreground) - When notification is received in foreground     |
| `handleNotificationWithUserInfoDictionary:isAppLaunch:withController:` | [`handleBackgroundNotificationClick:withCompletionHandler:`](/sdkx_ios/notifications/#push-delegates-background) - When notification is clicked in background |
