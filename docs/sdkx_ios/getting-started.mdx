...
description: Follow these simple steps to add Helpshift in-app support to your iOS app.
---
...
<a id="spm"></a>
## Automated Integration using Swift Package Manager
...
Refer [User Hub documentation](/sdkx_ios/identity-user-hub/#user-hub-implementation-flow-diagram) for SDK integration details.