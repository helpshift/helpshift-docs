...
For more details on these events, please check the [Delegates](/sdkx_ios/delegates.mdx) page.
...
This API leverages the existing Helpshift delegates system to notify the app in case of any errors. For more details on the error events that can be triggered by this API, please refer the [Delegates](/sdkx_ios/delegates.mdx) page.
