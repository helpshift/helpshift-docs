...
|                                               |                                                                                     |
| --------------------------------------------- | ----------------------------------------------------------------------------------- |
| helpshift-plugin-unity-[version].unitypackage | Unity package of Helpshift SDK X                                                    |
...
<a id="resolve-android-support-library-requirements"></a>
