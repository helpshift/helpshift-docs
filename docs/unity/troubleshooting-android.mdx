...
<a id="unity2020-android-lib-issue"></a>
...
<a id="android-studio-gradle-fix"></a>
...
<a id="fix-inbuilt-gradle-build"></a>
...
<a id="steps-to-build-with-android-x"></a>
...
<a id="commandInvocationFailure-manifest"></a>
...
<a id="commandInvocationFailure-noResourceFound"></a>
...
<a id="resource-not-found-error"></a>
...
<a id="fcm-background-notifications"></a>
