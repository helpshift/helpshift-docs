...
found in the `values-<language-code>/values<language-code>.xml` file, under the following folders in _&lt;sdk_download_path&gt;/HelpshiftUnityAndroidResources/helpshift-plugin/src/main/res/_ -
...
You can set the SDK language for the given locale using this API.
...
```
    ...
    HelpshiftSdk.getInstance().setSDKLanguage("zh_CN");
