...
<a id="enableDialogUIForTablets"></a>
...
<a id="enableInAppNotification"></a>
...
<a id="configure-support-library-version"></a>
...
<a id="minimum-issue-desc-length"></a>
