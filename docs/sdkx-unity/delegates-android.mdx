...
In response to this event, you should refresh the JWT for the current user and [log them in](/sdkx-unity/identity-user-hub-android/#logging-in-your-end-users) again with the new JWT.
...
[log them in](/sdkx-unity/identity-user-hub-android/#logging-in-your-end-users) the SDK with the new JWT to avoid disrupting their session.
