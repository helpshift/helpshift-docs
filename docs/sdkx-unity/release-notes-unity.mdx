...
- Added support for User Hub (User Identity & Profiles) and related user data collection APIs.
  - For more details on user identities, refer [User Identities](/sdkx_android/identity-user-hub/) page for Android and [User Identities](/sdkx_android/identity-user-hub/) page for iOS.
  - For more details on user data collection, refer [Tracking](/sdkx_android/tracking/#update-global-user-data) page for Android and [Tracking](/sdkx_android/tracking/#update-global-user-data) page for iOS.
...
- Included debug symbols (HelpshiftX.framework.dSYM ) file inside the zip file.
...
- `minSDKVersion` is now updated to 19 but plugin is functional only [above API 24.](/sdkx-unity/getting-started-android/#version-requirements)
