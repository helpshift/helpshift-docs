...
- SDK X 10.3.0 is supported on Android 7 and above (API level 24 and above). You can still compile your app using a minimum API level of 16, but the support starts for API level 24 and above.
...
- Helpshift SDK X supports Android 14, but Unity currently lacks official support for this version. Developers using Unity may face compatibility issues when integrating SDK X with Android 14.
