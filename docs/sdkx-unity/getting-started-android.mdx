...
|                                              |                                                                                                                 |
| -------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| helpshiftX-plugin-unity-v10.5.0.unitypackage | Unity package of Helpshift SDK X                                                                                |
| unity-jar-resolver (v1.2.186.0)              | Resolves Android Helpshift package support lib dependencies.                                                    |
...
| HelpshiftBackgroundFCM.androidlib            | Sample Android library to support push notifications in background or killed state.                             |

</div>

<Admonition type="info" title="Note">
  `unity-jar-resolver`, `iOS/dSYM/HelpshiftX.framework.dSYM` and `HelpshiftBackgroundFCM.androidlib` is not available in package published via Unity Asset Store.
  For using these files, please download the package from above and unzip the downloaded file.
</Admonition>
...
- Import the **Unity Jar Resolver** plugin into your Unity project
  ...
  1. In the Open Unity project, navigate to **Assets** drop-down menu and select the **Import Package** > **Custom Package**
  2. From the unzipped Helpshift SDK, select `unity-jar-resolver/external-dependency-manager-1.2.186.unitypackage` file to import the Unity Jar resolver.
