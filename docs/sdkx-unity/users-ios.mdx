  ...
  Dictionary<string, string> userDetails = new Dictionary<string, string>
        {
            ...
            { "userEmail", <your_unique_useremail> },
  ...
  Dictionary<string, string> userDetails = new Dictionary<string, string>
        {
            ...
            { "userEmail", <your_unique_useremail> },
            { "userName", <your_user_name> },
            { "userAuthToken", <generated-auth-token>}
        };
...
<table>
  ...
  <tr>
    <td>HelpshiftAuthenticationFailureReason <br />
.AUTH_TOKEN_NOT_PROVIDED</td>
