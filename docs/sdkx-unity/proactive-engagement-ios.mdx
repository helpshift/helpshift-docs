...
Before starting with Proactive Engagement, please ensure you have integrated push notifications with Helpshift SDK. Please refer [Notifications](/sdkx-unity/notifications-ios) page for integration guide.
...
Existing API to pause in-app support notifications - [PauseDisplayOfInAppNotification](/sdkx-unity/notifications-ios/#pause-in-app) - affects Proactive Engagement notifications as well. This API will pause/unpause the showing of in-app notifications to the end user when application is in foreground.
