...
<a id="set-custom-issue-fields"></a>
...
This API is meant to be used along with the new [User Identity system](/sdkx-unity/identity-user-hub-ios). Use this API to [update global attributes](/sdkx-unity/identity-user-hub-ios/#update-global-user-data) associated with the logged in user.
...
This API is meant to be used along with the new [User Identity system](/sdkx-unity/identity-user-hub-ios). Use this API to [update app specific attributes](/sdkx-unity/identity-user-hub-ios/#update-app-specific-user-data) associated with the logged in user.
