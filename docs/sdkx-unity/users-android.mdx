  ...
  <tr>
    ...
    <td>
      <ul>
        ...
        <li> If the value of "userId" is empty string, ater trimming spaces, then do not include this parameter in "login" call. </li>
      </ul>
</td>
  </tr>
  <tr>
    ...
    <td>
      <ul>
        ...
        <li> If the value of "userEmail" is empty string, ater trimming spaces, then do not include this parameter in "login" call. </li>
  </tr>
  <tr>
    <td>userAuthToken</td>
    <td>Optional</td>
    ...
    <td>
      <ul>
        ...
        <li> If the value of "userAuthToken" is empty string, ater trimming spaces, then do not include this parameter in "login" call. </li>
      </ul>
</td>
