...
|------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| `ClearAnonymousUserOnLogin`                                            | [`clearAnonymousUserOnLogin(shouldClear)`](/sdkx-unity/users-ios/#anonymous-users)  - Pass boolean true to clear/false to not clear                           |
| `showConversationWith:config:`                                         | [`ShowConversation(configMap)`](/sdkx-unity/support-tools-ios/#conversation-view)  - No need to pass in view controller                                     |
| `showFAQsWith:config:`                                                 | [`ShowFAQs(configMap)`](/sdkx-unity/support-tools-ios/#faqs-view)  - No need to pass in view controller                                             |
| `showFAQSection:with:config:`                                          | [`ShowFAQSection(sectionId, configMap)`](/sdkx-unity/support-tools-ios/#faq-section-view)  - No need to pass in view controller                                      |
| `showSingleFAQ:with:config:`                                           | [`ShowSingleFAQ(faqId,configMap)`](/sdkx-unity/support-tools-ios/#faq-view)  - No need to pass in view controller                                       |
