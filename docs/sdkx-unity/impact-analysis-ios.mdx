...
|                                                       |               |
| ----------------------------------------------------- | ------------- |
| **Helpshift's Chat screen (`ShowConversation`)**      | adds `8.1` MB |
| **Helpshift's FAQs screen (`ShowFAQs`)**              | adds `5.8` MB |
| **Helpshift's FAQ section screen (`ShowFAQSection`)** | adds `6.2` MB |
| **Helpshift's single FAQ screen (`ShowFAQ`)**         | adds `8.5` MB |
...
| **Helpshift's single FAQ screen (<code>showFAQ:</code>)**         | adds <code>10</code> MB.                                                           |
...
|                                                                   |                                                                                   |
| ----------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| **Helpshift's Chat screen (<code>showConversation:</code>)**      | adds <code>8.6</code> MB (This depends on number of messages on the chat screen). |
| **Helpshift's FAQs screen (<code>showFAQs:</code>)**              | adds <code>8.3</code> MB.                                                         |
| **Helpshift's FAQ section screen (<code>showFAQSection:</code>)** | adds <code>8.1</code> MB.                                                         |
| **Helpshift's single FAQ screen (<code>showFAQ:</code>)**         | adds <code>8</code> MB.                                                           |
