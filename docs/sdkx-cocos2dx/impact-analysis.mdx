...
| FAQs screen (`showFAQs()`)              | adds `5.9` MB (This depends on number of FAQ sections on the screen).  |
| FAQ section screen (`showFAQSection()`) | adds `5.9` MB (This depends on number of FAQS in the section).         |
| Single FAQ screen (`showFAQ()`)         | adds `5.9` MB (This depends on content of the FAQ).                    |
