...
import { Admonition, CodeBlock, Intro } from "@site/src/components/forDocs";
...
When a Cocos2dx iOS app is integrated with Helpshift plugin, the increase in the size of IPA file is around 600 KB.
