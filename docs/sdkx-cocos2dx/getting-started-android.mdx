...
Helpshift is now integrated in your app. You should now use the [support APIs](/sdkx-cocos2dx/support-tools-android) to present FAQ or conversation screens inside your app.
