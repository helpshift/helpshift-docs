...
Helpshift is now integrated in your app. You should now use the support APIs to [present FAQ](/sdkx-cocos2dx/support-tools-android#faqs-view) or [conversation screens](/sdkx-cocos2dx/support-tools-android#conversation-view) inside your app.
