...
Our new Identity system - [User Hub](/sdkx-cocos2dx/identity-user-hub/), introduces various APIs for managing users and their data. Refer to the linked section for details.
