...
- Added support for User Hub (User Identity & Profiles) and related user data collection APIs.
  - For more details on user identities, refer [User Identities](/sdkx-cocos2dx/identity-user-hub/) page for Android and [User Identities](/sdkx-cocos2dx/identity-user-hub/) page for iOS.
  - For more details on user data collection, refer [Tracking](/sdkx-cocos2dx/tracking/#update-global-user-data) page for Android and [Tracking](/sdkx-cocos2dx/tracking/#update-global-user-data) page for iOS.
...
- `minSDKVersion` is now updated to 19. Refer [OS support policy](/sdkx-cocos2dx/getting-started-android/#version-requirements) for more details.
