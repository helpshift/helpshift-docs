...
2. In your app, handle this notification such that when a user opens the app through notification, you pass the outbound support link in your notification data to Helpshift SDK by calling `HelpshiftCocosBridge.handleProactiveLink(String link)`.
...
public class HandleNotificationActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (bundle != null && bundle.getBoolean("proactiveNotification")) {
            ...
            HelpshiftCocosBridge.handleProactiveLink(url);
        }
        finish();
    }
}
...
You need to call this API after [HelpshiftCocosBridge.install() API](/sdkx-cocos2dx/getting-started-android/#initializing) and before HelpshiftCocosBridge.handleProactiveLink()
