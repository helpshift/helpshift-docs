...
- Follow the instructions [here](/sdkx-cocos2dx/getting-started-android/#adding-to-project) to add Helpshift SDK X to your project.
...
Refer to SDK X Cocos2dx plugin’s [Getting Started](/sdkx-cocos2dx/getting-started-android/) guide for more information.
...
- [App review request](/cocos2d-x/reviews-and-feedback-android/#review-reminder-in-sdk)
- [Manual App Rating request ](/cocos2d-x/reviews-and-feedback-android/#app-rating-api)
- [Automatic Reviews request](/cocos2d-x/reviews-and-feedback-android/#configuring-automatic-review-requests)
