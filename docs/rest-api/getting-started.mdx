...
| GET     | https://api.helpshift.com/v1/ `<domain>` /bulk_actions/`{task-id}`         | retrieve task information             |
| GET     | https://api.helpshift.com/v1/ `<domain>` /bulk_actions/`{task-id}`/errors  | retrieve task errors (if any)         |
| GET     | https://api.helpshift.com/v1/ `<domain>` /bulk_actions/`{task-id}`/results | retrieve task results                 |
