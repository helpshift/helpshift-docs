...
| Command | Request URL                                                                          | Description                    |
| ------- | -----------------------------------------------------------------------------------  | ------------------------------ |
| POST    | https://api.helpshift.com/v1/ `<domain>` /identity/bulk_actions/                     | create bulk tasks              |
| GET     | https://api.helpshift.com/v1/ `<domain>` /identity/bulk_actions/`{task-id}`          | retrieve task information      |
| GET     | https://api.helpshift.com/v1/ `<domain>` /identity/bulk_actions/`{task-id}`/errors   | retrieve task errors (if any)  |
| GET     | https://api.helpshift.com/v1/ `<domain>` /identity/bulk_actions/`{task-id}`/results  | retrieve task results          |

<Admonition type="info" title="Note">
User Idenity Bulk APIs are in Beta Phase, please contact support to know more about it.
</Admonition>
