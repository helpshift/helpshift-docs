...
| ------------- | --------------------------------------------------------------------------------------------------------------------------- | --------------------------------- |
| identities    | Array of maps, each map contains an identity value which can be used to uniquely identify the end user.                     | ```text[{"uid": "uid-1"}, {"email": "user@example.org", "verified": "true""}, {"discord_id": "293846823745"}] ``` |
