...
<a id="helpshift-delegates-implementation"></a>
...
<a id="conversation-status-event"></a>
...
<a id="helpshift-session-started-delegate"></a>
...
<a id="helpshift-sesstion-ended-delegate"></a>
