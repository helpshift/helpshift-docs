...
## Handle deep links in your Xamarin App
...
<a id="handle-deep-link-android"></a>
### Deep links in Xamarin Android app
...
<a id="handle-deep-link-ios"></a>
### Deep links in Xamarin iOS app
