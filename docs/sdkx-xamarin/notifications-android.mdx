...
All the public APIs in the SDK should be called after initializing the SDK via [HelpshiftSdk.Install() API](/sdkx-xamarin/getting-started#initialize)
...
Once this is done, you can use the **HelpshiftSdk.HandlePush(Dictionary<string, object\> pushNotificationData)** API to send the payload received in the notification.
...
namespace HelpshiftXamarinTestApp.Droid
{
    ...
    public class MyApplication : Application
    {
        ...
        override public void OnCreate()
        {
            ...
            Dictionary<String, Object> installC = new Dictionary<String, Object>();
            installC.Add("enableLogging", true);
            installC.Add("screenOrientation", ScreenOrientation.Portrait);
            installC.Add("notificationIcon", Resource.Drawable.app_icon);
