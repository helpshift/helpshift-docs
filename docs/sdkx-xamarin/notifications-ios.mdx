...
The Helpshift [install call](/sdkx_xamarin/getting-started/#initializing) supports flags for configuring SDK behaviour. Currently we support one flag i.e `enableInAppNotification`.
