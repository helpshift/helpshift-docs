...
<Steps title="New to Helpshift? Try out sample projects in 3 clicks">
  <Step
    ...
    subtitle="Ready to use XCode projects"
    link="https://github.com/helpshift/helpshift-ios-sdk-examples/"
    newTab={true}
  />
  <Step
    number="2"
    ...
    link="/ios/samples/#support-app"
    newTab={true}
  />
  <Step
    number="3"
    title="File your first ticket"
    subtitle='Tap "Report issue" to talk to yourself'
    link="/ios/samples#test-integration"
    newTab={true}
  />
</Steps>
...
To start using Helpshift `[% ios.sdk_version  %]` in your project, add one of the following lines to your `Podfile` according to the version which you wish to integrate.
