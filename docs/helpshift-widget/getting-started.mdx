...
Above mentioned configuration like `domain`, `platformId`, `appId` and `widgetType` are mandatory for initializing the Helpshift Widget. For additional configurations refer [here](/helpshift-widget/configuration/)
