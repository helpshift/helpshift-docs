...
Helpshift widget is now available on your website. Test it out by starting a helpcenter or chat.
...
If you are having issues with your widget integration, head over to the [Troubleshooting](/web-chat/troubleshooting) section for further help.
