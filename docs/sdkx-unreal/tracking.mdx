...
<Image
  src="/static/books/unreal/custom_metadata_show_conversation_empty.png"
  width="full"
/>
...
This API is meant to be used along with the new [User Identity system](/sdkx-unreal/identity-user-hub). Use this API to [update global attributes](/sdkx-unreal/identity-user-hub/#update-global-user-data) associated with the logged in user.
...
This API is meant to be used along with the new [User Identity system](/sdkx-unreal/identity-user-hub). Use this API to [update app specific attributes](/sdkx-unreal/identity-user-hub/#update-app-specific-user-data) associated with the logged in user.
