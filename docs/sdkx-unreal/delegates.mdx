...
|-------------------------------|------------|--------|
| HelpshiftEventUserClickOnAction  | userClickOnAction | String |
| HelpshiftEventDataActionType  | actionType | String |
| HelpshiftEventDataActionData  | actionData | String |
| HelpshiftEventDataActionTypeCall  | call | String |
| HelpshiftEventDataActionTypeLink  | link | String |
...
- Event data:
  ...
  |-------------------------------|--------|--------|--------- |
  | HelpshiftEventDataPublishID | publishId | String | Conversation ID of the ongoing issue |
  | HelpshiftEventDataMessageType | type | String | Message Type of the message |
  | HelpshiftEventDataMessageBody | body | String | The actual message sent by the agent or empty |
  | HelpshiftEventDataCreatedTime | createdTs | Long | Unix epoch timestamp in ms |
  | HelpshiftEventDataAttachments | attachments | Map<String, Object>> | Attachments, if they are present |
  | HelpshiftEventDataURL | url | String | URL of the attachment |
  | HelpshiftEventDataContentType | contentType | String | MIME type of the attachment |
  | HelpshiftEventDataFileName | fileName | String | File name of the attachment |
  | HelpshiftEventDataSize | size | Integer | Size of the attachment in bytes |
