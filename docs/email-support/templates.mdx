...
Some of them, like the `{{ delimiter }}` placeholder are required, while
...
|                                         |                                                                                                                                                                                                                             |
| --------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `{{ delimiter }}`                       | This is the _### Do not reply below ..._ line at beginning of the email. It is used to separate old content from new. When a customer replies, the content above the delimiter is considered as the message.                |
...
| `{ latest_message }}`       | Brings the last message in the issue as plain text. This is useful for making preview lines in customer's mailbox. Learn more about preview text [here](https://litmus.com/blog/the-ultimate-guide-to-preview-text-support) |
...
| body        | This is the message body. Make sure you always enclose body in `{{{` and `}}}` to unescape the rich content.                                                                                             |
