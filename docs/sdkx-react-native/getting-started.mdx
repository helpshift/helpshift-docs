...
- **React Native New Architecture support**:
    - Supported for React Native version **0.76 and above**.
    - For projects using React Native version **below 0.76**, New Architecture (TurboModules/Fabric) is not supported out of the box. If you encounter build issues, please apply the fallback patch documented in the [Troubleshooting](/sdkx-react-native/troubleshooting/#new-architecture-fallback-patch) section.
