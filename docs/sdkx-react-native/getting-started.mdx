...
The `install` call takes a 3 parameters. out of which appid and domain is mendatory and config parameter is optional, which means you can pass an empty map. The meaning of different keys and their possible values for Android can be found [here](/sdkx-react-native/sdk-configuration)
