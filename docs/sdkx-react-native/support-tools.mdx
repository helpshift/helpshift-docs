...
Our new Identity system - [User Hub](/sdkx-react-native/identity-user-hub/), introduces various APIs for managing users and their data. Refer to the linked section for details.