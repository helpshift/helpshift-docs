...
All the public APIs in the SDK should be called after initializing the SDK via [install](/sdkx-react-native/getting-started#start-using)
...
To configure SDK, you can pass various config options as a parameter. Check out more configuration options [here](/sdkx-react-native/sdk-configuration).
