...
- If the sound needs to be changed later on, it is recommended to create your own notification channels. Refer [this](/sdkx-react-native/sdk-configuration#notificationChannels).
...
This config represents the tracking user actions. For more information check [tracking](/sdkx-react-native/tracking).
