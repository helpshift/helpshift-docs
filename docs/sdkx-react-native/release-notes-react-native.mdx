...
- Introduced [**Proactive Engagement**](/sdkx-react-native/proactive-engagement) feature which lets you reach out to your players by sending Push/In app Notifications on their mobile devices and engage in various ways including starting conversations.
  - For integration details, please refer [Proactive Engagement](/sdkx-react-native/proactive-engagement)
  - Please note that the SDK does not ask for posting notifications permission for client application. For Proactive Engagement, you need to ask for these permissions for your application. Please refer [Notifications](/sdkx-react-native/notifications-ios) for iOS and [POST_NOTIFICATION](https://developer.android.com/develop/ui/views/notifications/notification-permission) for android.
  - iOS: Use the new notification handling APIs to correctly handle push notifications of Proactive Engagement on iOS. Refer [Notifications](/sdkx-react-native/notifications-ios) page.
...
- Deprecated old [Outbound Support](/sdkx-react-native/outbound-support) with introduction of [Proactive Engagement](/sdkx-react-native/proactive-engagement).
