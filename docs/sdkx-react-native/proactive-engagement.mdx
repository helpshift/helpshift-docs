...
Before starting with Proactive Engagement, please ensure you have integrated push notifications with Helpshift SDK, please refer [Notifications Android](/sdkx-react-native/notifications-android) or [Notifications iOS](/sdkx-react-native/notifications-ios) page for integration guide.
...
## Setting defaults for notification properties {#notification-defaults}
