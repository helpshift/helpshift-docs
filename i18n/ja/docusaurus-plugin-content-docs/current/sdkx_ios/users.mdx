...
このセクションでは、従来の方式でユーザーを統合する方法について説明します。新しいIDシステムとの統合については、[このページ](/sdkx_ios/identity-user-hub)を参照してください。
...
- ログインAPIは、渡された`userId`または`userEmail`が有効かどうかを示すブーリアン値を返します。
...
## ユーザーの本人確認 {#verify-identity-of-users}

### アプリ内で本人確認を構成する {#configure-identity-verification}
