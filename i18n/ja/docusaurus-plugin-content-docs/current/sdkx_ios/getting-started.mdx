...
Xcode 14からビットコードが非推奨となったため、SDK Xの最新バージョンに基づくビットコード不使用ビルドを作成しました。このビルドは、[こちら](https://d3e51fp79zp4el.cloudfront.net/sdkx/latest/ios/helpshiftx-sdk-ios-non-bitcode.zip)からダウンロードできます。
...
iOS10.x以下のバージョンでは、アクセス許可に関連する問題により添付ファイルのアップロードはサポートされていません。
