...
- イベントのデータ:
  ...
  | キー                             | データ型              | 値                                               |
  | -------------------------------- | --------------------- | ------------------------------------------------ |
  | HelpshiftEvent.DATA_PUBLISH_ID   | string                | 現在進行中の問題の会話 ID                        |
  ...
  | HelpshiftEvent.DATA_URL          | string                | 添付ファイルの URL                               |
  | HelpshiftEvent.DATA_CONTENT_TYPE | string                | 添付ファイルの MIME タイプ                       |
